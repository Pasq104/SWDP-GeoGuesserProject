...
typedef enum {
    DATA_TYPE_IMU_ACCELERATION,      // IMU interna accelerometro
    DATA_TYPE_IMU_GYROSCOPE,         // IMU interna giroscopio
    DATA_TYPE_EXT_IMU_ACCELERATION,  // IMU esterna accelerometro
    DATA_TYPE_EXT_IMU_GYROSCOPE,     // IMU esterna giroscopio
    DATA_TYPE_MAGNETOMETER           // Magnetometro esterno
} BLE_DataType;
